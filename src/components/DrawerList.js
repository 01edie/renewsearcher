...
{/* panel list */}
        <ListItem disablePadding>
          <ListItemButton>
            ...
            <ListItemText primary="Lab" secondary="Refine, Store and Read your searchings at one place." />
          </ListItemButton>
        </ListItem>
        <Divider/>
        <ListItem disablePadding>
          <ListItemButton>
            ...
            <ListItemText primary="Features" secondary="Check out the features available for free users and registered users" />
          </ListItemButton>
        </ListItem>
        <Divider/>
        <ListItem disablePadding>
          <ListItemButton>
            ...
            <ListItemText primary="Register" secondary="Go for a quick registration to use full fledged functionalities" />
          </ListItemButton>
        </ListItem>
        </List>
